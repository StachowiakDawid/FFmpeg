...
const AVFilter ff_vf_reverse_mpdecimate = {
    .name          = "reverse_mpdecimate",
    .description   = NULL_IF_CONFIG_SMALL("Remove non-duplicate frames."),
    .init          = init,
    .uninit        = uninit,
    .priv_size     = sizeof(DecimateContext),
    .priv_class    = &reverse_mpdecimate_class,
